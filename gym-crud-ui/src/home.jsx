        ...
        <div className="container mt-5">
            ...
            <div className="row justify-content-center g-4">
                ...
                <div className="col-md-3">
                    <div className="card h-100 shadow-sm border-0 text-center">
                        <div className="card-body">
                            ...
                            <p className="card-text">Give your feedback or see what you've submitted.</p>
                            <button className="btn btn-outline-info w-100" onClick={() => navigate(`/user/feedback/${user.userId}`)}>
                                Give Feedback
                            </button>
                        </div>
                    </div>
                ...
                <div className="col-md-3">
                    <div className="card h-100 shadow-sm border-0 text-center">
                        <div className="card-body">
                            <h5 className="card-title">My Payments</h5>
                            <p className="card-text">Review your membership and trainer payments.</p>
                            <button className="btn btn-outline-dark w-100" onClick={() => navigate(`/user/payment/${user.userId}`)}>
                                View Payments
                            </button>
                        </div>
                    </div>
